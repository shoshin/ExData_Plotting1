...
with(my_data, plot(DateTime,Sub_metering_1, type="l", ylab = "Energy Sub Metering", col="black"))
...
legend("topright", lty = 1, col =c("black", "red", "blue"),legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3")) # note lty makes it a line in the legend
